...
export default function MobileMenuDrawer({ isOpen, onClose, socialMediaLinksList, donationDetails }) {
  return (
    <Drawer open={isOpen} onClose={onClose} className="lg:hidden" anchor="right" classes={{ paper: 'w-full max-w-96' }}>
      <div className="flex h-full flex-col bg-other-black transition-all">
